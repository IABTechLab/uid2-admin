...
public final class MaxKeyUtil {
    ...
    public static int getMaxKeysetKeyId(Collection<KeysetKey> inputKeys, Integer oldMaxKeyId) throws Exception {
        final List<KeysetKey> sortedKeys = inputKeys.stream()
