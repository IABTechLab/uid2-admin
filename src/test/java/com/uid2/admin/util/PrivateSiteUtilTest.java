...
public class PrivateSiteUtilTest {
    ...
    class EncryptionKeys {
        ...
        public void testGenerateEncryptionKeyData() {
            ...
            final OperatorKey[] operatorKeys = {
                    new OperatorKey("key3", "keyHash3", "name3", "contact3", "aws-nitro", 2, false, 3, new HashSet<>(), OperatorType.PRIVATE),
                    new OperatorKey("key4", "keyHash4", "name4", "contact4", "aws-nitro", 2, false, 4, new HashSet<>(), OperatorType.PRIVATE),
                    new OperatorKey("key5", "keyHash5", "name5", "contact5", "aws-nitro", 2, false, 5, new HashSet<>(), OperatorType.PUBLIC),
                    new OperatorKey("key6", "keyHash6", "name6", "contact6", "aws-nitro", 2, false, 6, new HashSet<>(), OperatorType.PRIVATE),
                    new OperatorKey("key7", "keyHash7", "name6", "contact6", "aws-nitro", 2, false, 7, new HashSet<>(), OperatorType.PUBLIC)
            };
            ...
            final ClientKey[] clientKeys = {
                    new ClientKey("key3", "keyHash3", "", "name3", "contact3", Instant.now(), readerRole, 3, false),
                    new ClientKey("key4", "keyHash4", "", "name4", "contact4", Instant.now(), readerRole, 4, false),
                    new ClientKey("key7", "keyHash7", "", "name7", "contact7", Instant.now(), readerRole, 7, false)
            };
    ...
    class Sites {
        ...
        public void testGenerateSiteData() {
            ...
            final OperatorKey[] publicOperatorKeys = {
                    new OperatorKey("key2", "keyHash2", "name2", "contact2", "aws-nitro", 2, false, Const.Data.AdvertisingTokenSiteId, new HashSet<>(), OperatorType.PUBLIC),
                    new OperatorKey("key5", "keyHash5", "name5", "contact5", "aws-nitro", 5, false, 5, new HashSet<>(), OperatorType.PUBLIC),
            };
            final OperatorKey[] privateOperatorKeys = {
                    new OperatorKey("key3", "keyHash3", "name3", "contact3", "aws-nitro", 3, false, 3, new HashSet<>(), OperatorType.PRIVATE),
                    new OperatorKey("key4", "keyHash4", "name4", "contact4", "aws-nitro", 4, false, 4, new HashSet<>(), OperatorType.PRIVATE),
            };
    ...
    static class OperatorBuilder {
        private final OperatorKey operator = new OperatorKey("key3", "keyHash3", "name3", "contact3", "aws-nitro", 2, false, siteId1, ImmutableSet.of(), OperatorType.PRIVATE);
    ...
    static class ClientBuilder {
        ...
        public ClientKey build() {
            return new ClientKey("key3_1", "keyHash3_1", "", "name3_1", "contact3_1", Instant.now(), roles, siteId, isDisabled);
        }
    }
}
